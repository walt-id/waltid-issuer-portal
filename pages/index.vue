        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <p class="text-muted">
                <b>Howest</b> University of Applied Sciences.
              </p>
            </div>
            <div class="col-sm-4 offset-md-1 py-4">
              ...
              <ul class="list-unstyled">
                <li><a href="https://walt.id" class="text-white">web: https://howest.be</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container">
          <a href="#" class="navbar-brand d-flex align-items-center">
            ...
            <!--        </svg>-->
            <img class="me-3 howest-logo" src="/howest-wit-en.svg" alt="" width="170px">
          </a>
          <ul class="nav navbar-nav navbar-right">
            <li>
              ...
              <button class="navbar-toggler howest-logo" type="button" data-bs-toggle="collapse" data-bs-target="#navbarHeader" aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-5 howest-section">
          <div class="col-lg-6 col-md-8 mx-auto">
            ...
            <p class="lead text-muted fw-normal mb-4 howest-headline">
